def crop(crop_name):
    ...
    "sunflower":["sunflower.jpg",  "GADAG, RAICHUR, SHIMOGA, BELLARY, BANGALORE URBAN", "rabi", "Phillippines, United States, Bangladesh"],
    "sugarcane":["sugarcane.jpg","UTTAR KARNATAKA, MANDYA, TUMKUR, BELLARY, BELGAUM" , "kharif", "Kenya, United Arab Emirates, United Kingdom"]
    }
